...
@Component({
  selector: 'app-sms-reach-chart',
  templateUrl: './sms-reach-chart.component.html',
  styleUrls: ['./sms-reach-chart.component.scss']
})
export class SmsReachChartComponent implements OnInit, OnDestroy {
